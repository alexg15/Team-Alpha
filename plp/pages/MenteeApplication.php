...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $intStatus = isset($_POST["intStatus"]) ? ($_POST["intStatus"] == "Yes" ? "intYes" : "intNo") : "intDefault";
  $firstGen = isset($_POST["firstGen"]) ? ($_POST["firstGen"] == "Yes" ? "firstYes" : "firstNo") : "firstDefault";
  ...
  $honors = isset($_POST["honors"]) ? ($_POST["honors"] == "Yes" ? "honYes" : "honNo") : "honDefault";
  $GPA = $_POST["GPA"];
  if (is_numeric($GPA)) {
    $GPA = floatval($GPA);
  } else {
  ...
  //Program Info
  $travel = isset($_POST["travel"]) ? ($_POST["travel"] == "Yes" ? "travYes" : "travNo") : "travDefault";
  $trans = isset($_POST["trans"]) ? ($_POST["trans"] == "Yes" ? "transYes" : "transNo") : "transDefault";
  $mentorPref = $_POST["mentorPref"];
  $goals = $_POST["goals"];
  $interests = $_POST["interests"];
  $industryPref = $_POST["industryPref"];
  $mentorGenPrefCheck = isset($_POST["mentorGenPrefCheck"]) ? ($_POST["mentorGenPrefCheck"] == "Yes" ? "prefYes" : "prefNo") : "prefDefault";
