...
<html>
	...
	<div class = "wordy">
		...
		<h3>	Our mentor application is multi-purpose: it serves as a screening tool to identify the right mentors for our program, helps us to match our mentors 
					...
					will become your main connection platform with our program and your source for announcements, resources, events, and more. 
		</h3>			
		...
		<h3> Please note that there are five application sections to complete. It should take you 15-30 minutes, depending on your background. 
		</h3>
	</div>
<input type="checkbox" id="" name="timeCheck" value=""> I understand this application must be completed in one sitting and wish to continue
</p>
