...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2023 at 03:24 AM
...
--
CREATE DATABASE IF NOT EXISTS `plp database` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `plp database`;
...
(111, 'James', 'Alexander', 'Seneca', 'male', 'Ft Worth', 'Yes', 'Yes', 'Yes', 0, '7853074077', '2025 Bliss Rd', 'Fort Worth', 'TX', '76177', 'No', '2025 Bliss Road', 'Ft Worth', 'TEXAS', '76177', 'United States', 'English', 'Fun', 'Fun', 'No', 'male', 'Computer Science', 'false', '6', '', 'Alexander.j.seneca@gmail.com', '', '', '', '', 'Best', 'Computers', 'Lockheed', 'Engineer', 'Fix Stuff', 'Aerospace and defense', '2023-11-06', '', '', '', '', '', 'Comp Guys', 'Computer Science', 'Computer Science', '', '2014', '', '');
...
--
ALTER TABLE `mentee_accounts`
  MODIFY `mentee_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'pk auto inc', AUTO_INCREMENT=131554;

--
-- AUTO_INCREMENT for table `mentor_accounts`
--
ALTER TABLE `mentor_accounts`
  MODIFY `mentor_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;
COMMIT;
